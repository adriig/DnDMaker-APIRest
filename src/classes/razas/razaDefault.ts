...
export class SubRaza extends Raza {
    ...
    public constructor(_id: number, _NombreRaza: string, _Multiplicadores: Array<Stats>, _Habilidades: Array<Habilidades>, _Origen: string, _Subtipo: string, _Nombres: Array<String>, RazaDependiente: string, OrigenSubRaza: string) {
